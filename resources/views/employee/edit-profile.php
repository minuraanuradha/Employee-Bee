<div class="mx-auto  p-2">
    <div class="mb-6">
        <h2 class="text-h5 text-orange ">Edit Employee Profile</h2>
        <p class="text-p-regular-new text-lightgray">Update your personal information and preferences.</p>
    </div>

    <form method="POST" action="?path=employee/updateProfile" enctype="multipart/form-data" class="space-y-4">
        <!-- Personal Information Card -->
        <div class="bg-black/40 rounded-lg p-6 shadow">
            <h3 class="text-h5 text-orange mb-4">Personal Information</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-p-regular-new text-lightgray mb-2">Full Name *</label>
                    <input 
                        type="text" 
                        name="full_name" 
                ...
                <div>
                    <label class="block text-p-regular-new text-lightgray mb-2">Email *</label>
                    <input 
                        type="email" 
                        name="email" 
                ...
                <div>
                    <label class="block text-p-regular-new text-lightgray mb-2">Country</label>
                    <select 
                        name="country" 
                        class="w-full rounded-lg px-4 py-2 text-sm bg-black text-white border border-gray-700 focus:border-orange focus:outline-none"
                    >
                ...
                <div>
                    <label class="block text-p-regular-new text-lightgray mb-2">Birth Date</label>
                    <input 
                        type="date" 
                        name="birthdate" 
                ...
                <div>
                    <label class="block text-p-regular-new text-lightgray mb-2">NIC/National ID</label>
                    <input 
                        type="text" 
        ...
        <div class="bg-black/40 rounded-lg p-6 shadow">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-p-regular-new text-lightgray mb-2">Portfolio URL</label>
                    <input 
                        type="url" 
                        name="portfolio_url" 
        ...
        <div class="bg-black/40 rounded-lg p-6 shadow">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-p-regular-new text-lightgray mb-2">Skills (comma separated)</label>
                    <textarea 
                        name="skills" 
                        rows="4"
                ...
                <div>
                    <label class="block text-p-regular-new text-lightgray mb-2">Education (one per line)</label>
                    <textarea 
                        name="education" 
                        rows="4"
        ...
        <div class="bg-black/40 rounded-lg p-6 shadow">
            ...
            <div class="flex items-center gap-4">
                <div class="flex-1">
                    <label class="block text-p-regular-new text-lightgray mb-2">Upload Resume (PDF)</label>
                    <input 
                        type="file" 
                        name="resume" 
                        accept=".pdf,.doc,.docx"
        ...
        <div class="bg-black/40 rounded-lg p-6 shadow">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="flex-1">
                    <label class="block text-p-regular-new text-lightgray mb-2">Upload New Picture</label>
                    <input 
                        type="file" 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add your validation/character counter logic here if needed
});
</script> 