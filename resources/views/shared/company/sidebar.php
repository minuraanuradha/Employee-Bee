...
?>
<aside id="sidebar" class="w-52 m-2 transition-all duration-300 lg:block text-white rounded-lg shadow-xl hidden bg-stone-950">
            ...
            <ul class="space-y-2 content-start min-h-full overflow-hidden text-xs">
                ...
                <li>
                    <a href="?path=company/employees"
                        ...
                        <img src="assets/icons/User.svg" alt="Employees Icon" class="h-3.5 w-3.5 mr-1">
